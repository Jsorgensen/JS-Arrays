...
//Create a function named 'looper' that is given family as it's only argument, loops through the given array, and alerts every item in the array.
  ...
  //Code Here
var looper = (arr) => arr.map(item => alert(item));
...
//Write a function called reversedLooper that is given letters as it's only argument and loops through the given array backwards alerting every item in the array starting at the end.
  ...
  //Code Here
var reversedLooper = (arr) => arr.slice(0).reverse().map(item => alert(item));
...
//Write a function named evenFinder that is given nums as it's only argument and removes all values that aren't even from the given array.
  ...
  //Code Here
var evenFinder = arr => arr.filter(item => item % 2 === 0);
...
//Your Code Here
var createUser = () => {return {name, email: '', password: '', username: ''}};
users.push(user1, createUser(), createUser());
